...
screen navigation():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_start_%s.png" xpos 489 ypos 470 focus_mask True action Start () 
        ...
        imagebutton auto "gui/mm_save_%s.png" xpos 619 ypos 557 focus_mask True action ShowMenu("load")

        #textbutton _("Opciones") action ShowMenu("preferences")

        imagebutton auto "gui/mm_options_%s.png" xpos 597 ypos 628 focus_mask True action ShowMenu("preferences")
        ...
        imagebutton auto "gui/mm_info_%s.png" xpos 637 ypos 697 focus_mask True action ShowMenu("about")
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/mm_exit_%s.png" xpos 629 ypos 768 focus_mask True action Quit(confirm=not main_menu)
...
screen about():
    ...
    use game_menu(_("Acerca de"), scroll="viewport"):
        ...
        vbox:
            ...
            text _(" ")
            text _("Desarrolladores: SweetHeart Studio 2024.")
            text _(" ")
            text _("Artistas visuales y narrativos:")
            text _("Tamara Abigail, Geraldine García, Samantha Castellanos e Israel Martínez")
            text _(" ")
            text _("Programación: Geraldine García")
            text _(" ")
            text _("Musicalización: Geraldine García")
            text _("Samples: BandLab originals")
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                droppable True
                dropped piece_drop1
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle01_%s.png" % (i + 1) alpha 0.0

screen hreassemble_puzzle1:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                draggable False
                droppable True
                dropped hpiece_drop1
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle01_%s.png" % (i + 1) alpha 0.0

screen reassemble_puzzle01:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                draggable False
                droppable True
                dropped piece_drop01
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle01_%s.png" % (i + 1) alpha 0.0

screen hreassemble_puzzle01:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                draggable False
                droppable True
                dropped hpiece_drop01
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle01_%s.png" % (i + 1) alpha 0.0

screen reassemble_puzzle2:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle02_%s.png" % (i + 1) alpha 0.0

screen hreassemble_puzzle2:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                draggable False
                droppable True
                dropped hpiece_drop2
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle02_%s.png" % (i + 1) alpha 0.0

screen reassemble_puzzle02:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                draggable False
                droppable True
                dropped piece_drop02
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle02_%s.png" % (i + 1) alpha 0.0

screen hreassemble_puzzle02:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                draggable False
                droppable True
                dropped hpiece_drop02
                pos piece_cordinates[i]
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle02_%s.png" % (i + 1) alpha 0.0

screen reassemble_puzzle3:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
    ...
    draggroup:
        ...
        for i in range(page_pieces):
            drag:
                ...
                #anchor(0.5, 0.5)
                focus_mask True
                image "puzzle03_%s.png" % (i + 1) alpha 0.0

screen hreassemble_puzzle3:
    image "puzzle_bk.png"
    frame:
        background "puzzle_m.png"
        xysize full_page_size
