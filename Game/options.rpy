...
define config.name = _("Sabores y Pinceles")
...
define build.name = "SaboresyPinceles"
...
define config.main_menu_music = "audio/Happyending.mp3"
...
define config.save_directory = "SaboresyPinceles-1715727268"
